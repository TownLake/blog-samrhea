...
const TimelineRole = ({
  ...
  // Get appropriate colors from the theme config, passing darkMode from context
  const colors = getTimelineColors(companyType, darkMode);
  const textStyles = getTextStyles(darkMode);
