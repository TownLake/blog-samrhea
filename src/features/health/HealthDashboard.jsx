...
import WeightDeficitModal from '/src/features/health/components/WeightDeficitModal.jsx';
...
const HealthDashboard = () => {
  ...
  const metrics = {
    ...
    cumulativeDeficit: { title: "14d Calorie Deficit", value: latestCumulativeDeficit?.calorie_delta_rolling_14d?.toLocaleString() ?? '--', unit: "kcal", ...getMetricCategoryInfo('calorie_delta_rolling_14d', latestCumulativeDeficit?.calorie_delta_rolling_14d), sparklineData: createSparklineData(processedData, 'calorie_delta_rolling_14d'), icon: TrendingDown, fullData: weightVsDeficitData, dataKey: "cumulative_deficit", displayMode: 'compact' },
