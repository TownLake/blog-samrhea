// src/features/health/components/charts/MonthlyChart.jsx
...
import { getMetricCategoryInfo, METRIC_RANGES, CATEGORY_COLORS } from '/src/utils/healthCategories.js';
import { chartMargins, monthlyChartConfig, axisConfig, gridConfig } from '/src/config/chartConfig.js';
